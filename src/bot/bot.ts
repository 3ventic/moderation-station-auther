...
export const GUILD_ID: string =
  process.env.DISCORD_GUILD_ID || "352896412880470017";
export const DISCORD_API_BASE: string = "https://discord.com/api/v8";
...
export const setRolesAndNick: (
  ...
  const rolesToAdd: Discord.Role[] = newRoles.filter(
    (r) => !member.roles.cache.has(r.id)
  );
